...
${assertion}
    ...
    extractClickTarget(step) {
        ...
        if (step.toLowerCase().includes('button'))
            return 'Submit';
        if (step.toLowerCase().includes('link'))
            return 'Click here';
        if (step.toLowerCase().includes('forgot'))
            return 'Forgot password?';
        return 'Click me';
    }
    extractInputTarget(step) {
    ...
    extractExpectedText(text) {
        ...
        if (text.toLowerCase().includes('error'))
            return 'Error';
        if (text.toLowerCase().includes('visible'))
